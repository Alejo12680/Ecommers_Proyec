    ...
    <header>
        <nav>
            ...
            <section class="nav_right">
                ...
                <p><?php echo $totalCantidad; ?></p> <!-- funcion de ../backend/cantidad.php para que de la cantidad de veces que se le da al producto -->
            </section> 
        </nav>
    </header>
    <main>
                ...
                ?>
                    <article class="main_trajeta">
                        ...
                        <form action="../backend/shopping.php" method="POST">
                            ...
                            <button type="submit" id="buttom" >Comprar </button>
                        </form>
